			   ...
			   <?php 
                ...
                <div class="price1">
                  <div class="blockheight">
                    ...
                    <div class="btn2_outer"><a class="btn2" href="<?php echo get_permalink($p_id);?>">read more</a></div>
                  </div>  
                  <div class="price2">
                    <div class="blockheight">
					<?php 
                    ...
                    <div class="btn2_outer"><a class="btn2" href="<?php echo get_permalink($p_post_data->post_id);?>">read more</a></div>
                  </div>  
                    <div class="price2" style="border:0;background:none;">                       
					   ...
					   ?>
							 <?php 
								$p_post_id = '1093';
								$lang_pg_id = icl_object_id($p_post_id,"post",false,$langcode);
								$p_post_data = get_post($lang_pg_id);					
								$page_title = $p_post_data->post_title;
                            ?>
                            <?php $image2 = wp_get_attachment_image_src( get_post_thumbnail_id($lang_pg_id), 'large'); ?>
