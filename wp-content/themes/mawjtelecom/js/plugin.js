			...
			addNav : function() {
				$slidewrap.each(function(i) {						
					var $oEl = $(this),
						...
						navMarkup = [
							'<div class="hdg_right" class="slidecontrols" role="navigation">',
							'	<a href="#' + currentSlider + '" class="' + opt.namespace + '-next">Next</a>',
							'	<a href="#' + currentSlider + '" class="' + opt.namespace + '-prev">Prev</a>',
							'</div>'
							].join(''),
						nextprev = {
