<?php
/*
Plugin Name: Zerocall Tech
Plugin URI: http://www.zerocall.com/
Description: Display Content for Zerocall Tech. 
Version: 1.0

*/
class zerocall_tech extends WP_Widget
{
   function zerocall_tech()
	{
		$widget_options = array(
			'classname'	=> 'zerocall_tech',
			'description' => __('Display Content for "Zerocall Tech"') );
			
		// Call the parent class WP_Widget	
		parent::WP_Widget('zerocall_tech', 'Zerocall Tech', $widget_options);
