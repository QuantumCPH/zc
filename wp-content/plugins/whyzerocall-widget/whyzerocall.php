<?php
/*
Plugin Name: Why Zerocall
Plugin URI: http://www.zerocall.com/
Description: Display Content for "Why Zerocal?". 
Version: 1.0

*/
class whyzerocall extends WP_Widget
{
   function whyzerocall()
	{
		$widget_options = array(
			'classname'	=> 'whyzerocall',
			'description' => __('Display Content for "Why Zerocal?"') );
			
		// Call the parent class WP_Widget	
		parent::WP_Widget('whyzerocall', 'Why Zerocall', $widget_options);
